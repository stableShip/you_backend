...
<body>
						...
						<form name="productOrder" id="form" method="post">
							<fieldset>
								...
								<p>
									...
									<input class="text-input small-input" type="text" name="name" value="${productOrder.name}"
								...
								<p>
									...
									<input class="text-input small-input" type="text" name="water_content" value="${productOrder.water_content}"
								...
								<p>
									...
									<input class="text-input small-input" type="text" name="comment" value="${productOrder.comment}" /> <br />
								</p>

								<p>
									<input class="button" type="button" onclick="updateProductOrder()" value="<spring:message code="backend.form.button.update" />" />
								</p>
							</fieldset>
						</form>
					</div>
	...
	<script>
		...
		function updateProductOrder() {
			...
			$.ajax({
				url:"<%=request.getContextPath()%>/backend/glaze/productOrderController/productOrderUpdate.do",
				type : "post",
				data : data,
				datatype : "json",
				success : function(data) {
					if (data.errors != null) {
						...
						$('#resultName').attr('value',
								data.productOrder.name);
						$('#resultWaterContent').attr('value',
								data.productOrder.water_content);
						$('#resultComment').attr(
								'value',
								data.productOrder.comment);
