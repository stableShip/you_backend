		...
		<div id="main-content">
			...
			<div class="content-box">
				<div class="content-box-header">
					<h3><spring:message code="backend.admin.add.title" /></h3>
					<div class="clear"></div>
				</div>
				<div class="content-box-content">
					<div class="tab-content default-tab" id="tab1">
						<div class="notification attention png_bg">
							...
							<div><spring:message code="backend.admin.add.alert" /></div>
						</div>
						...
						<form name="dto" action="<%=request.getContextPath()%>/backend/general/accountController/accountAdd.do" method="post">
							<fieldset>
								<p>
