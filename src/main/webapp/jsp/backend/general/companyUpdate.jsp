		...
		<div id="main-content">
			...
			<div class="content-box">
				<div class="content-box-header">
					<h3><spring:message code="backend.company.update.title" /></h3>
					<div class="clear"></div>
				</div>
				<div class="content-box-content">
					<div class="tab-content default-tab" id="tab1">
						<div class="notification attention png_bg">
							...
							<div><spring:message code="backend.company.update.alert" /></div>
						</div>
						...
						<form name="company" action="<%=request.getContextPath()%>/backend/general/companyController/companyUpdate.do"
							method="post">
							<fieldset>
								...
								<p>
									<label><spring:message code="backend.company.update.label.description" /></label>
									<textarea class="text-input textarea" name="description" cols="79" rows="15" >${company.description}</textarea>
								</p>
								<p>
