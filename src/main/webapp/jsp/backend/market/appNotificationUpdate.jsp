			...
			<div class="content-box">
				...
				<div class="content-box-content">
					<div class="tab-content default-tab" id="tab1">
						...
						<form name="appNotification" action="<%=request.getContextPath()%>/backend/market/notificationController/appNotificationUpdate.do" method="post" enctype="multipart/form-data">
							<fieldset>
								<p>
									<input type="hidden" name="appId" value="${appNotification.appId}"/>
									<input type="hidden" name="appNotificationId" value="${appNotification.appNotificationId}"/>
									<label>应用图标</label>
									<img src="<%=request.getContextPath()%>/${appNotification.iconUrl}" id="displayIcon" height="48" width="48" />
