...
<body>
	<div id="successDialog">
		<form id="successForm" action="<%=request.getContextPath()%>/backend/toner/tonerController/findToner.do" method="post">
			<fieldset>
				<p>
					<strong><spring:message code="backend.toner.add.label.name" />&nbsp;&nbsp;&nbsp; </strong><input type="text" id="resultName" class="text-input medium-input" readonly="readonly" /><br />
				</p>
			</fieldset>
		</form>
	</div>
				...
				<div class="content-box-content">
					<div class="tab-content default-tab" id="tab1">
						<div class="notification attention png_bg">
							...
							<div><spring:message code="backend.toner.update.alert" /></div>
						</div>
						...
						<form name="toner" id="form" method="post">
							<fieldset>
								...
								<p>
									<label><spring:message code="backend.toner.update.label.name" /> <b style="color:#FF0000"><spring:message code="backend.form.label.required" /></b></label>
								...
								<p>
									<input class="button" type="button" onclick="updateToner()" value="<spring:message code="backend.form.button.update" />" />
								</p>
							</fieldset>
						</form>
					</div>
	...
	<script>
		...
		function updateToner() {
			...
			$.ajax({
				url:"<%=request.getContextPath()%>/backend/toner/tonerController/tonerUpdate.do",
				type : "post",
				data : data,
				datatype : "json",
