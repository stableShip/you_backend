...
<body>
	<div id="successDialog">
		<form id="successForm" action="<%=request.getContextPath()%>/backend/ad/notificationAdController/notificationAdList.do" method="post">
			<fieldset>
				<p>
					<strong><spring:message code="backend.notificationAd.add.label.name" />&nbsp;&nbsp;&nbsp; </strong><input type="text" id="resultNotificationAdName" class="text-input medium-input" readonly="readonly" /><br /> 
					<strong><spring:message code="backend.notificationAd.add.label.appname" />&nbsp;&nbsp;&nbsp; </strong><input type="text" id="resultNotificationAdAppName" class="text-input medium-input" readonly="readonly" /><br /> 
					<strong><spring:message code="backend.notificationAd.add.label.promotionWord" />&nbsp;&nbsp;&nbsp; </strong><input type="text" id="resultNotificationAdPromotionWord" class="text-input medium-input" readonly="readonly" /><br /> 
					<strong><spring:message code="backend.notificationAd.add.label.iconUrl" />&nbsp;&nbsp;&nbsp; </strong><input type="text" id="resultNotificationAdIconUrl" class="text-input medium-input" readonly="readonly" /><br /> 
					<strong><spring:message code="backend.notificationAd.add.label.dowmloadUrl" />&nbsp;&nbsp;&nbsp; </strong><input type="text" id="resultNotificationAdDownloadUrl" class="text-input medium-input" readonly="readonly" /><br /> 
					<strong><spring:message code="backend.notificationAd.add.label.appkey" />&nbsp;&nbsp;&nbsp; </strong><input type="text" id="resultNotificationAdCpaAppKey" class="text-input medium-input" readonly="readonly" /><br /> 
				</p>
			</fieldset>
		</form>
	</div>
					...
					<div class="tab-content default-tab" id="tab1">
						...
						<form name="notificationAd" id="form" method="post">
							...
							<p>
								...
								<p>
									<label>应用名称 <b style="color:#FF0000"><spring:message code="backend.form.label.required" /></b></label>
									<input class="text-input small-input" type="text" name="appName" 
								...
								<p>
									<label>CPA Key</label>
									<input class="text-input small-input" type="text" name="cpaAppkey" 
									 data-validation-error-msg="<spring:message code="backend.channel.add.err-message.name" />"/> <br />
								</p>
								<p>
									<input class="button" type="button" onclick="addNotificationAd()" value="<spring:message code="backend.form.button.add" />" />
								</p>
							</fieldset>
						</form>
					</div>
	...
	<script>
		...
		function addNotificationAd() {
			var data = $('#form').serialize();
			$.ajax({
				url:"<%=request.getContextPath()%>/backend/ad/notificationAdController/notificationAdAdd.do",
				type : "post",
				data : data,
				datatype : "json",
